...
namespace STWiki.Data.Migrations
{
    ...
    [Migration("20250907081740_AddCollabTables")]
    partial class AddCollabTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("STWiki.Data.Entities.CollabCheckpoint", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("CollabCheckpoints");
                });

            modelBuilder.Entity("STWiki.Data.Entities.CollabSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AwarenessJson")
                        .HasMaxLength(4000)
                        .HasColumnType("character varying(4000)");

                    b.Property<byte[]>("CheckpointBytes")
                        .HasColumnType("bytea");
                    ...
                    b.HasIndex("PageId", "ClosedAt")
                        .HasDatabaseName("IX_CollabSessions_PageId_ClosedAt");

                    b.ToTable("CollabSessions");
                });

            modelBuilder.Entity("STWiki.Data.Entities.CollabUpdate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("STWiki.Data.Entities.CollabCheckpoint", b =>
                {
                    b.HasOne("STWiki.Data.Entities.CollabSession", "Session")
